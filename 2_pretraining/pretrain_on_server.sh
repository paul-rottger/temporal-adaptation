...
#SBATCH --job-name=17-08-pretrain
#SBATCH --mail-type=ALL
#SBATCH --mail-user=paul.rottger@oii.ox.ac.uk
#SBATCH --output=17-08-pretrain.out
#SBATCH --error=17-08-pretrain.err
...
python run_mlm.py \
    ...
    --train_file $DATA/gab-language-change/0_data/clean/unlabelled_reddit/month_splits/train_2017_08_1m.txt \
    ...
    --output_dir $DATA/gab-language-change/adapted-models/reddit/month-models/bert-2017_08_1m \
