...
# returns pseudo-perplexity (exp of cross-entropy loss on masked words) on test set
...
class DataTrainingArguments:
    ...
    output_name: Optional[str] = field(default='results', metadata = {"help": "PR custom: specify name for eval results .txt"}
    )
...
def main():
    ...
    if training_args.do_eval:
        ...
        pseudo_perplexity = math.exp(eval_output["eval_loss"])
        results["pseudo_perplexity"] = pseudo_perplexity

        output_eval_file = os.path.join(training_args.output_dir, f"{data_args.output_name}.txt")
